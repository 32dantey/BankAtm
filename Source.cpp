...
//
//				balance = balance - amt;
//				_strdate_s(tr_date); //saving current date
//
//				file_temp << fname << " " << lname << " " << phone << " " << dob << " " << type
//					<< " " << accountNumber << " " << passcode << " " << balance << endl;
//
...
//	ofstream tr_write("transec.txt", ios::out | ios::app);
//
//	_strdate_s(tr_date); //time.h ,function for saving current date
//	while (!file_read.eof())
//	{
//
//		file_read >> fname;
...
//bank atm program with acount inter-transfer capability
int Acc_Number;
int option;
void Menu() {
	cout << "**********MENU**********" << endl;
...
void Option() {
	...
	case 5:
		break;
	default:
		cout << "You are not yet a member of our bank.Do join us";
		break;
	}
}
...
int main() {
	cout << "Welcome.Enter your bank account: ";
...
void Welcome() {
	cout << "Welcome.Enter your account number : ";
	cin >> Acc_Number;
}
...
public:
	...
	double  setAcc_Number(double acc_number) {
		Acc_Number = acc_number;
	};
	double getAcc_Number() {
		return Acc_Number;
	}
	...
	Users(string name, double acc_number, double balance) {
		Name = name;
		Acc_Number = acc_number;
		Balance = balance;
	};
...
int main() {
	...
	Users user1 = Users("Janet Ochieng", 23517483, 8700);
	Users user2 = Users("Dantey ", 47895466, 350);
	Users user3 = Users("Erick Okoye", 87631897, 1250);
	Users user4 = Users("Harriet Tina", 34359299, 543);
};
